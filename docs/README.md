...
- [decisions/ADR-010-playlist-export.md](decisions/ADR-010-playlist-export.md): 내 플레이리스트 → Spotify/Tidal export(Eat The Shared의 짝) — 사용자 계정에 진짜 플레이리스트 생성→공유 링크. 쓰기 스코프 보유(재인증 X), 대상 플랫폼 ID 있는 곡만(스킵 보고), v1 Spotify+Tidal확인후
...
- [superpowers/specs/2026-06-15-playlist-export-design.md](superpowers/specs/2026-06-15-playlist-export-design.md): 내 플레이리스트 → Spotify/Tidal export 상세 설계(create+add, 대상 플랫폼 ID 곡만·스킵 보고, Tidal 엔드포인트 구현 시 확인) ([ADR-010](decisions/ADR-010-playlist-export.md))
